...
# python Minimax_new/evaluate.py --agents-path ./gomoku ./baseline --num-plays 128 --num-workers 24 我先手，应该胜率较高
# python Minimax/evaluate.py --agents-path ./baseline ./gomoku --num-plays 64 --num-workers 24  我后手，0胜率
